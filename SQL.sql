...
CREATE TABLE Film (
	...
	Regisseur nvarchar(40) NOT NULL,
	Jaar int,
	Tijd int NOT NULL,
	Genre nvarchar(20),
...
CREATE TABLE Locatie (
	Naam nvarchar(40) NOT NULL UNIQUE,
...
CREATE TABLE Zaal (
	ZaalID nvarchar(20) NOT NULL,
	Rijen int NOT NULL,
	Kolommen int NOT NULL,
	Locatie nvarchar(40) NOT NULL,
...
CREATE TABLE Voorstelling (
	VoorstellingID int IDENTITY(1,1) NOT NULL,
	FilmID int NOT NULL,
	Datum datetime2 NOT NULL,
	ZaalID nvarchar(20),
	Bedrag decimal(4,2),
	FilmUitvoering nvarchar(40),
	CONSTRAINT VoorstellingPK PRIMARY KEY (VoorstellingID),
...
BEGIN
	...
	IF Datum < GETDATE() THEN
		@msg = 'U kunt geen voorstelling inplannen met een oude datum';
	END IF
END
...
CREATE TABLE Kaart (
	KaartID int IDENTITY(1,1) NOT NULL,
	VoorstellingID int NOT NULL,
	Stoelnummer int,
	Rijnummer int,
	Code nvarchar(50),
	CONSTRAINT KaartPK PRIMARY KEY (VoorstellingID, Stoelnummer, Rijnummer),
...
SELECT VoorstellingID,COUNT(*) AS 'Aantal'
FROM Kaart
GROUP BY VoorstellingID

SELECT VoorstellingID
FROM Voorstelling
